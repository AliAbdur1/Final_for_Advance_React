  ...
  return (
    <div className='home' style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', color: 'white'}}>
      <br/>
        ...
        <div className="home-bio" style={{width: '70%',backgroundColor: 'rgb(192, 218, 249)', padding: '20px', borderRadius: '10px', textAlign: 'left', boxShadow: '0 0 10px rgba(0, 0, 0, 0.5)'}}>
          <p style={{color: 'black', fontSize: '20px', fontFamily: 'monospace' }}>I began my professional career working in hospitality and retail. Now I am a Full Stack Web Developer specializing in React and Node.<br/>
